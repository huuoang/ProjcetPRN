...
namespace Projcet.Controllers
{
    public class AdminController : Controller
    {
        ...
        public IActionResult AdminDashboard()
        {
            ...
            ViewBag.Revenue = context.Bookings.ToList().Sum(r => r.Total);
            return View();
        }
        ...
        public IActionResult BookingManagement(int page)
        {
            if (IsAdmin())
            {
                //Pagination
                int pageSize = 10;
                decimal pageNumber = Math.Ceiling((decimal)context.Bookings.Include(x => x.User).Count() / pageSize);
                ...
                ViewBag.BookingList = context.Bookings.Include(x => x.User).ToPagedList(page, pageSize);
                ViewBag.Pages = pageNumber;
                ViewBag.CurrentPage = page;
                return View();
            }
